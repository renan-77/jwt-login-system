...
//         this._.camelize(this.appname) + angularUtils.appName(this);
//
...
//             this.options.appPath || bowerJson.appPath || "app";
//         this.options.appPath = this.env.options.appPath;
//     }
//
//     this.env.options.testPath =
//         this.env.options.testPath || bowerJson.testPath || "test/spec";
//
...
//             this.expandFiles(
//                 path.join(this.env.options.appPath, "/scripts/**/*.ts"),
//                 {}
//             ).length > 0
//         ) {
...
//             !this.options.coffee &&
//             this.expandFiles(
//                 path.join(this.env.options.appPath, "/scripts/**/*.coffee"),
//                 {}
//             ).length > 0
//         ) {
...
//     yeoman.generators.Base.prototype.template.apply(this, [
//         src + this.scriptSuffix,
//         path.join(this.env.options.testPath, dest.toLowerCase()) +
//             this.scriptSuffix
//     ]);
// };
//
...
// };
//
// Generator.prototype.addScriptToIndex = function(routeName) {
//     try {
//         var appPath = path.join(__dirname, "/route/templates");
//         var fullPath = path.join(appPath, "routes.py");
...
//                     @api.route('/newRoute')
//                     class newRouteAll(Resource):
//                         def get(self):
//                             return
//                         def post(self):
//                             return
//                     @api.route('/newRoute_id')
//                     class newRouteWithId(Resource):
//                         def get(self):
//                             return
//                         def post(self):
//                             return
...
//         });
//     } catch (e) {
//         this.log.error(chalk.yellow(e));
//     }
// };
//
// Generator.prototype.generateSourceAndTest = function(
//     appTemplate,
//     testTemplate,
//     targetDirectory,
//     skipAdd
